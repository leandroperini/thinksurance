 ...
 */
final class Version20210119061223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__permission AS SELECT id, name FROM permission');
        $this->addSql('DROP TABLE permission');
        $this->addSql('CREATE TABLE permission (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO permission (id, name) SELECT id, name FROM __temp__permission');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__role_permission AS SELECT role_id, permission_id FROM role_permission');
        ...
        $this->addSql('INSERT INTO role_permission (role_id, permission_id) SELECT role_id, permission_id FROM __temp__role_permission');
        $this->addSql('DROP TABLE __temp__role_permission');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__permission AS SELECT id, name FROM permission');
        $this->addSql('DROP TABLE permission');
        $this->addSql('CREATE TABLE permission (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO permission (id, name) SELECT id, name FROM __temp__permission');
        $this->addSql('DROP TABLE __temp__permission');
        $this->addSql('DROP INDEX IDX_6F7DF886D60322AC');
        $this->addSql('DROP INDEX IDX_6F7DF886FED90CCA');
